...
$(function () {
    ...
    var dt_station_table = $('.datatables-station'),
        select2 = $('.select2'),
        statusObj = {
            0: {is_active: 'Pending', class: 'bg-label-warning'},
            1: {is_active: 'Active', class: 'bg-label-success'}
        };

    // Company datatable
    if (dt_station_table.length) {
        var dataFilePath = '';
        var stationRoute = document.getElementById('fetchStationRoute').getAttribute('data-url');
        var dt_company = dt_station_table.DataTable({
            ajax: stationRoute, // JSON file to add data
            columns: [
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return '<span class="fw-semibold">' + $code + '</span>';
                    }
                },
                {
                    // Plans
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return '<span class="fw-semibold">' + $company + '</span>';
                    }
                },
                {
                    // Plans
            ...
            initComplete: function () {
                ...
                this.api()
                    ...
                    .every(function () {
                        var column = this;
                        var select = $(
                            '<select id="FilterStation" class="form-select text-capitalize"><option value=""> Select Status </option></select>'
                        )
