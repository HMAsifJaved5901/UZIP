...
$(function () {
    ...
    var dt_lookup_table = $('.datatables-configuration'),
        select2 = $('.select2'),
        ...
        var dt_configuration = dt_lookup_table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    targets: 1,
                    render: function (data, type, full, meta) {
                        var $config_key = full['config_key'];
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return (
                            ...
                            '<a href="javascript:void(0)" id="update_configuration' + $id + '" data-configurationid="' + $id + '" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddConfiguration" class="text-body">'+editText+'</a>' +
                            '<a href="javascript:;" id="delete_configuration' + $id + '" data-configurationid="' + $id + '" data-action_type="'+$action+'" class="text-body delete-record">'+deletedText+'</a>' +
                            '</div>' +
                            '</div>'
                        );
                    }
    ...
    //     dt_configuration.row($(this).parents('tr')).remove().draw();
    //     Swal.fire(
    //         'Deleted!',
    //         response.message,
    //         'success'
