...
$(function () {
    ...
    var dt_service_table = $('.datatables-service'),
        select2 = $('.select2'),
    ...
    if (dt_service_table.length) {
        var dataFilePath = '';
        var stationRoute = document.getElementById('fetchServiceRoute').getAttribute('data-url');
        var dt_company = dt_service_table.DataTable({
