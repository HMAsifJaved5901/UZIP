...
$(function () {
    ...
    var dt_lookup_table = $('.datatables-category'),
        select2 = $('.select2'),
    ...
    if (dt_lookup_table.length) {
        var categoryRoute = document.getElementById('fetchCategoryRoute').getAttribute('data-url');
        var dt_category = dt_lookup_table.DataTable({
            ajax: categoryRoute, // JSON file to add data
            columns: [
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    targets: 3,
                    render: function (data, type, full, meta) {
                        var $parentCategory = full['parent_category'];
                        return '<span class="fw-semibold">' + $parentCategory + '</span>';
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return (
                            ...
                            '<a href="javascript:void(0)" id="update_category' + $id + '" data-categoryid="' + $id + '" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddCategory" class="text-body">'+editText+'</a>' +
                            '<a href="javascript:;" id="delete_category' + $id + '" data-categoryid="' + $id + '" class="text-body delete-record">'+deletedText+'</a>' +
                            '</div>' +
                            '</div>'
                        );
                    }
            ...
            buttons: [
                ...
                },
                {
                    ...
                    className: 'add-new btn btn-default Rectangle_4',
                    attr: {
