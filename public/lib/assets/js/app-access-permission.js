...
$(function () {
    ...
    if (dataTablePermissions.length) {
        var PermissionRoute = document.getElementById('fetchPermissions').getAttribute('data-url');
        ...
        dt_permission = dataTablePermissions.DataTable({
            ajax: PermissionRoute, // JSON file to add data
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        // };
                        var roleBadgeObj = {
                            admin: '<a href="javascript:void(0)"><span class="badge bg-label-primary m-1">Administrator</span></a>',
                            web: '<a href="javascript:void(0)"><span class="badge bg-label-warning m-1">Users</span></a>'
                        };
