            ...
            >
                ...
                <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
                    <form class="add-new-transaction-category pt-0" id="addNewTransactionSaveFormInPro" method="POST"
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="add-transaction-category-name">Transaction Category Name</label>
                            <input
                                    type="text"
                                    class="form-control"
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="add-transaction-category-description">Transaction Category Description</label>
                            <input
                                    type="text"
                                    class="form-control"
    ...
    <x-slot name="scripts">
        ...
        <script>
            $(document).on('click', '.delete-record', function () {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "This Transaction category won't be able to be used!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (response) {
                                Swal.fire(
                                    'Deleted!',
                                    'The transaction category has been deleted.',
                                    'success'
                                ).then(function() {
