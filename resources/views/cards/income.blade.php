                        ...
                        <div class="row m-sm-4 m-0">
                            <div class="col-md-6 mb-md-0 mb-4 ps-0">
                                <div class="d-flex svg-illustration mb-4 gap-2 align-items-center">
                                    ...
                                    <span class="app-brand-text fw-bold fs-4"> UZIP Income</span>
                                </div>
                            ...
                            <div class="col-md-6">
                                <dl class="row mb-2">
                                    ...
                                    <dt class="col-sm-5 mb-2 mb-sm-0 text-md-end ps-0 mt-2">
                                        <span class="fw-normal">Income Date:</span>
                                    </dt>
                                    <dd class="col-sm-7 d-flex justify-content-md-end pe-0 ps-0 ps-sm-2">
                                        <input type="text" class="form-control w-px-450 invoice-date"
                                               value="{{\Carbon\Carbon::parse($record->income_date)->format('F j, Y')}}" placeholder="YYYY-MM-DD"/>
                                    </dd>
                                </dl>
                                <dl class="row mb-2">
